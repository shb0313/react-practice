...
MyComponent.propTypes = {
    ...
    // Combined with javascript data tyoe
    props07: PropTypes.oneOfType([PropTypes.number, PropTypes.string]).inRequired,
    props08: PropTypes.arrayOf(PropTypes.bool).inRequired,
